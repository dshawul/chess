...
public:
	...
	void clear();
	void add(const board::Position& B, move::move_t m, int16_t bonus);
	int16_t get(const board::Position& B, move::move_t m) const;

private:
	int16_t h[NB_COLOR][NB_PIECE][NB_SQUARE];
};
